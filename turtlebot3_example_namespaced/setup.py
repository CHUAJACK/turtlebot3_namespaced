...
package_name = 'turtlebot3_example_tb3_1'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'turtlebot3_example_tb3_1.turtlebot3_interactive_marker.'
            'turtlebot3_interactive_marker:main',

            'turtlebot3_patrol_server = \
                turtlebot3_example_tb3_1.turtlebot3_patrol.turtlebot3_patrol_server:main',
            'turtlebot3_patrol_client = \
                turtlebot3_example_tb3_1.turtlebot3_patrol.turtlebot3_patrol_client:main',

            'turtlebot3_obstacle_detection = '
            'turtlebot3_example_tb3_1.turtlebot3_obstacle_detection.'
            'turtlebot3_obstacle_detection:main',

            'turtlebot3_absolute_move = '
            'turtlebot3_example_tb3_1.turtlebot3_absolute_move.'
            'turtlebot3_absolute_move:main',

            'turtlebot3_relative_move = '
            'turtlebot3_example_tb3_1.turtlebot3_relative_move.'
